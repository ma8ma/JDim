    ...
    , m_button_remove_old_title( "dat落ちしたスレのタイトルを削除する" )
{
    ...
    if( temp_cookies.empty() ) {
        ...
        str_cookies = "クッキー:\n" + MISC::Iconv( temp_cookies, Encoding::utf8, DBTREE::board_charcode( get_url() ) ) + "\n";
    }
    ...
    m_combo_charset.append( MISC::charcode_to_cstr( Encoding::utf8 ) );
    m_combo_charset.append( MISC::charcode_to_cstr( Encoding::sjis ) );
    m_combo_charset.append( MISC::charcode_to_cstr( Encoding::eucjp ) );
