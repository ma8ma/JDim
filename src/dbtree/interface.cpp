...
Encoding DBTREE::board_charcode( const std::string& url )
{
    return DBTREE::get_board( url )->get_charcode();
}


void DBTREE::board_set_charcode( const std::string& url, const Encoding charcode )
{
...
// スレの文字コード
Encoding DBTREE::article_charcode( const std::string& url )
{
    return DBTREE::get_article( url )->get_charcode();
}

// スレの文字コードをセット
void DBTREE::article_set_charcode( const std::string& url, const Encoding charcode )
{
