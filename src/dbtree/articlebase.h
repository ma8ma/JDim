...
namespace DBTREE
{
    ...
    class ArticleBase : public SKELETON::Lockable
    {
        ...
        Encoding m_charcode;         // 文字エンコーディング
      ...
      public:
        ...
        ArticleBase( const std::string& datbase, const std::string& id, bool cached, const Encoding charcode );
        ~ArticleBase();
        ...
        // 文字エンコーディング
        Encoding get_charcode() const noexcept { return m_charcode; }
        void set_charcode( const Encoding charcode ){ m_charcode = charcode; }
